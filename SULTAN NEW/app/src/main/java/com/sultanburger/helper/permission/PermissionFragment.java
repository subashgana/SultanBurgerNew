...
public class PermissionFragment extends Fragment implements PermissionConstants {
            ...
            case REQUEST_ID_PERMISSION_MULTIPLE:
                if (grantResults.length > 0) {
                    ...
                    for (DangerousPermission key : requestedPermissions.keySet()) {
                        ...
                        boolean shouldShowRequestPermissionRationale = shouldShowRequestPermissionRationale(key.toString());
                    ...
                    if (Validator.isValid(permissionCallback)) {
                        if (isAllPermissionsGranted) {
                            ...
                            if (!permissionRationale.isEmpty() && permissionCallback.shouldShowRequestPermissionRationale()) {
                                ...
                                PermissionUtil.showDialog(getContext(), permissionRationaleMessage, new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                ToastUtil.showToast(getContext(), SOME_PERMISSION_DENIED);
                            }
                        }
                    }
                }
